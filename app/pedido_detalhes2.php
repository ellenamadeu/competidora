<?php
// pedido_detalhes2.php
// Página semelhante a pedido_detalhes.php, mas sem o bloco de Agendamentos.
...
<head>
    ...
    <title>Detalhes do Pedido 2 - Competidora Adm</title>
...
<body class="text-gray-200 text-sm md:text-base"> 
    ...
    <div id="newItemModal" class="modal hidden">
        <div class="modal-content">
            ...
            <form id="newItemForm">
                ...
                <div class="modal-form-group">
                    <label for="itemAltura">Altura:</label>
                    <input type="text" id="itemAltura" name="altura" required>
                </div>
                <div class="modal-form-group">
                    <label for="itemLargura">Largura:</label>
                    <input type="text" id="itemLargura" name="largura" required>
                </div>
                <div class="modal-form-group">
                    <label for="itemQuantidade">Quantidade:</label>
                    <input type="text" id="itemQuantidade" name="quantidade" required>
                </div>
                <div class="modal-form-group">
                    <label for="itemValorUnitario">Valor Unitário:</label>
                    <input type="text" id="itemValorUnitario" name="valor_unitario">
                </div>
                <div class="modal-form-group">
                    <label for="itemValorTotal">Valor Total:</label>
                    <input type="text" id="itemValorTotal" name="valor_total" readonly>
                </div>
    ...
    <div id="updateItemModal" class="modal hidden">
        <div class="modal-content">
            ...
            <form id="updateItemForm">
                ...
                <div class="modal-form-group">
                    <label for="updateItemAltura">Altura:</label>
                    <input type="text" id="updateItemAltura" name="altura" required>
                </div>
                <div class="modal-form-group">
                    <label for="updateItemLargura">Largura:</label>
                    <input type="text" id="updateItemLargura" name="largura" required>
                </div>
                <div class="modal-form-group">
                    <label for="itemQuantidade">Quantidade:</label>
                    <input type="text" id="itemQuantidade" name="quantidade" required>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', async () => {
            ...
            document.getElementById('newPaymentModal').classList.add('hidden'); // Explicitamente ocultar no carregamento
            ...
            // Elementos do Modal de Agendamento (REMOVIDOS)
            // const newAppointmentModal = document.getElementById('newAppointmentModal');
            // const closeAppointmentModalBtn = newAppointmentModal.querySelector('.modal-close-btn');
            ...
            const updateItemAlturaInput = document.getElementById('itemAltura');
            const updateItemLarguraInput = document.getElementById('itemLargura');
            const itemQuantidadeInput = document.getElementById('itemQuantidade');
            const updateItemValorUnitarioInput = document.getElementById('itemValorUnitario');
            const updateItemValorTotalInput = document.getElementById('itemValorTotal');
                            ...
                            <div class="bg-gray-700 p-3 rounded-lg shadow mb-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="values-list">
                                        ...
                                        <div class="detail-item"><span class="detail-label">Subtotal:</span><span class="detail-value">${formatCurrency(data.subtotal_itens)}</span></div>
            ...
            // Funções de carregamento de dropdowns para Agendamento (mantidas, mas não chamadas no HTML)
            const loadAppointmentTimeDropdown = async (targetSelect, selectedValue = null) => { // Adicionado targetSelect
                try {
            ...
            const loadAppointmentOrderDropdown = async (targetSelect, selectedValue = null) => { // Adicionado targetSelect
                try {
            ...
            const loadFuncionariosDropdown = async (targetSelect, selectedValue = null) => { // Adicionado targetSelect
                try {
            ...
            // Event Listeners do Modal de Agendamento (REMOVIDOS)
            // closeAppointmentModalBtn.addEventListener('click', () => { // Removidos os listeners do modal de agendamento
            //     newAppointmentModal.classList.add('hidden');
            //     newAppointmentForm.reset(); 
            // });

            // cancelAppointmentBtn.addEventListener('click', () => { // Removidos os listeners do modal de agendamento
            //     newAppointmentModal.classList.add('hidden');
            //     newAppointmentForm.reset(); 
            // });
            ...
            window.addEventListener('click', (event) => {
                if (event.target == newAppointmentModal) { // Removida a verificação para o modal de agendamento
                    // newAppointmentModal.classList.add('hidden');
                    // newAppointmentForm.reset(); 
                }
            ...
            // Lidar com o envio do formulário de Novo Agendamento (REMOVIDO)
            ...
            //         status_agendamento: formData.get('status_agendamento') === '1' ? 1 : 0 
            //     };
