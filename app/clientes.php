            ...
            <div class="bg-gray-800 p-6 sm:p-8 rounded-lg shadow-xl">
                ...
                <div>
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6">
                        ...
                        <a href="cliente_novo.php" class="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition duration-300 ease-in-out flex items-center justify-center" accesskey="n">
